...
public class CopyOfSpatial extends javax.swing.JPanel {
 ...
 // Variables declaration - do not modify//GEN-BEGIN:variables
    ...
    public CopyOfSpatial(String args[]) {
    	runArgs = args;
        initComponents();
...
//        });
        ...
        add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 140, 110));
    ...
    private void initCustomComponents() {
        ...
        add(graphPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, 250, 250));
        ...
        add(magFieldGraphPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 11, 290, 290));
        ...
        add(gyroGraphPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(335, 300, 290, 290));
        ...
        add(compassBearingGraphPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 300, 290, 290));
...
//        pack();
    ...
    private void formWindowOpened() {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            attach_listener = new SpatialAttachListener(this.jPanel2, this.jPanel3,
            ...
            detach_listener = new SpatialDetachListener(this.attachedTxt, this.nameTxt,
                    this.serialTxt, this.versionTxt, this.numAccelAxesTxt, this.numGyroAxesTxt,
                    this.numCompassAxesTxt, this.dataRateScrl, this.dataRateTxt,
                    this.accelXTxt, this.accelYTxt, this.accelZTxt, this.gyroXTxt, this.gyroYTxt, this.gyroZTxt,
                    this.zeroGyroBtn, this.gyroXTxt1, this.gyroYTxt1, this.gyroZTxt1,
...
//
//            public void run() {
//                new CopyOfSpatial().setVisible(true);
//            }
//        });
//    }
