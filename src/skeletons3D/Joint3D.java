...
public class Joint3D {
	...
	// set joint position and visibility
	{
		if (pos == null)
			...
			jy = (double) pos.getY();
			jz = (double) pos.getZ();
//			jx = (double) pos.getX() * xyScale;
//			jy = (double) pos.getY() * xyScale;
//			jz = (double) pos.getZ() * zScale;
	...
	public Vector3d getPos() {
		return smoothPosns.getPosition();
	} // scaled position (or null)

	private void setVisibility(boolean toVisible)
	/*
	 * toggle the visibility of the joint (called by a limb connected to this
	 * joint)
	 */
	{
		if (toVisible) {
	...
	public String toString() {
		String joint = getJoint() + "," + jx + "," + jy + "," + jz;
		return joint;
	}
